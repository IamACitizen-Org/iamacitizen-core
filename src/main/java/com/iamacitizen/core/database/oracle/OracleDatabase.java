package com.iamacitizen.core.database.oracle;
...
/**
 * Classe..: OracleDatabase Objetivo:
 *
...
public class OracleDatabase extends AbstractDatabase {
	...
	private static String CONSTRAINT_SQL = "SELECT UC1.TABLE_NAME, UC1.CONSTRAINT_TYPE AS CT1, UC1.R_CONSTRAINT_NAME, "
			+ "UC2.TABLE_NAME AS TB2, UC2.CONSTRAINT_TYPE AS CT2, UC1.INDEX_NAME FROM ALL_CONSTRAINTS UC1 "
	...
	@Override
	public Constraint getConstraint(String owner, String name) throws SerigyDatabaseException {
	...
	public long getIdentityNextVal(String sequenceName) {
		...
		SQL.append("SELECT ").append(sequenceName).append(".NEXTVAL AS ID FROM DUAL");
		return super.generateIdentity(SQL.toString());
	}

	@Override
	protected long mapSequenceValue(ResultSet rs) throws SQLException {
		return rs.getLong(1);
	}

	@Override
	public String handleSQLError(SQLException e) {
		return new OracleSQLErrorMapper(this).SQLErrorHandler(e);
	}
}